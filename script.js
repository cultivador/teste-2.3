...
:root {
    --laranja-claro: #FF0000; /* Alterado para vermelho*/
    --alto-contraste-fundo: black;/* #000000*/
    --alto-contraste-texto: #ffffff;
    --alto-contraste-link: turquoise;/* #00ff9d*/
}
...
header {
    background-color: Turquoise;/* #ffffff*/
}
...
.formulario button {
    background-color: blue;/* #1503af*/
    border: none;
    font-weight: bold;
}

.form-control {
    background-color: white;/* #e70e7b*/
}
.menu-acessibilidade{
    position: fixed;
    top:2rem;
